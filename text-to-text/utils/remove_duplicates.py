# This file is taken from https://github.com/yanghoonkim/NQG_ASs2s. Many thanks to @yanghoonkim.
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_file', type = str, default = 'ouput3.pred')
    parser.add_argument('--out_file', type = str, default = 'output2.pred')
